...
class TagDeletedPage extends Page {
  ...
  public function getMain() {
    ...
    $output .= "<p>The tag you requested did at some point in time belong to the Automorphic project, but it was removed. You might be able to find a clue in the <a href='https://github.com/automorphic-project/automorphic-project/blob/master/tags/tags'>tags file</a>.</p>";
