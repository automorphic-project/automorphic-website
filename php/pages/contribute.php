...
class ContributePage extends Page {
  public function getMain() {
    ...
    $output .= "<li>It is very helpful if you edit the relevant TeX file directly and email the result, or even better: use Git and the <a href='http://github.com/automorphic-project/automorphic-project'>automorphic-project</a> repository.";
    ...
    $output .= "</ol> Please be aware that all contributions are licensed under the <a href='https://github.com/automorphic-project/automorphic-project/blob/master/COPYING'>GNU Free Documentation License</a>.  </p>";

    $output .= "<h2>Where to submit</h2>";
    $output .= "<p>Please email contributions to <a href='mailto:automorphic.project@gmail.com'>automorphic.project@gmail.com</a>. We will review, edit and if suitable update the Automorphic project with your changes.</p>";
    ...
    $output .= "<ol>";
    $output .= "<li>Download all the TeX files. They are contained in <a href='https://github.com/automorphic-project/automorphic-project/archive/master.zip'>this archive</a>.";
    ...
    $output .= "<pre><code>git clone git://github.com/automorphic-project/automorphic-project.git</code></pre>";
  ...
  public function getSidebar() {
    ...
    $output .= "So far " . sizeof($contributors) . " people have contributed to the Automorphic project, and these are:";
