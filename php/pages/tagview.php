...
class TagViewPage extends Page {
  ...
  public function getHead() {
    ...
    if ($this->tag["type"] == "chapter") {
      ...
      $value .= "    },";
      $value .= "    theme: {";
      $value .= "      editor: '/themes/editor/automorphic-editor.css',";
      $value .= "      preview: '/themes/preview/automorphic-preview.css',";
      $value .= "    },";
      $value .= "    parser : sfm,";
      $value .= "    shortcut : {";
      $value .= "      modifier : 0,";
  ...
  private function printCitation() {
    ...
    $value .= "<p>Use:";
    $value .= "<pre style='margin: -.2em 0 .8em 0'><code style='font-size: 90%'>\\cite[Tag " . $this->tag["tag"] . "]{automorphic-project}</code></pre>";
  ...
  private function printCommentInput() {
    ...
    $value .= "<p>All contributions are licensed under the <a href='https://github.com/automorphic-project/automorphic-project/blob/master/COPYING'>GNU Free Documentation License</a>.</p>";
  ...
  private function printLocation() {
    ...
    if ($this->tag["type"] != "chapter")
      $value .= "<li><a href='https://github.com/automorphic-project/automorphic-project/blob/master/" . $chapter["filename"] . ".tex#L" . $this->tag["begin"] . "-" . $this->tag["end"] . "'>lines " . $this->tag["begin"] . "&ndash;" . $this->tag["end"] . "</a> of <a href='https://github.com/automorphic-project/automorphic-project/blob/master/" . $chapter["filename"] . ".tex'><var>" . $chapter["filename"] . ".tex</var></a>";
    else
      $value .= "<li>which corresponds to the file <a href='https://github.com/automorphic-project/automorphic-project/blob/master/" . $chapter["filename"] . ".tex'><var>" . $chapter["filename"] . ".tex</var></a>";
  ...
  private function printView() {
    ...
    if ($this->tag["type"] != "chapter") {
      ...
      $value .= "<p>The code snippet corresponding to this tag is a part of the file <a href='https://github.com/automorphic-project/automorphic-project/blob/master/" . $this->tag["file"] . ".tex'><var>" . $this->tag["file"] . ".tex</var></a> and is located in <a href='https://github.com/automorphic-project/automorphic-project/blob/master/" . $this->tag["file"] . ".tex#L" . $this->tag["begin"] . "-" . $this->tag["end"] . "'>lines " . $this->tag["begin"] . "&ndash;" . $this->tag["end"] . "</a> (see <a href='" . href("tags#automorphic-epoch") . "'>updates</a> for more information).";
      $value .= "<pre><code>";
