...
class BrowsePage extends Page {
  ...
  private function printChapter($chapter, $filename, $number) {
    ...
    elseif ($chapter == "Bibliography")
      $value .= "<td class='download'><a href='https://github.com/automorphic-project/automorphic-project/blob/master/my.bib'><code>tex</code></a></td>";
    else
      $value .= "<td class='download'><a href='https://github.com/automorphic-project/automorphic-project/blob/master/" . $filename . ".tex'><code>tex</code></a></td>";
    // fifth column
    if ($chapter == "Bibliography")
