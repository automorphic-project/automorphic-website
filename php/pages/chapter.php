...
class ChapterPage extends Page {
  ...
  public function getSidebar() {
    ...
    $value .= "<li><a href='https://github.com/automorphic-project/automorphic-project/blob/master/" . $this->chapter["filename"] . ".tex'><code>tex</code> file for this chapter</a>";
    $value .= "</ul>";

    $value .= "<h2>Permalink</h2>";
    $value .= "<p>The number of chapters in the Automorphic project is likely to change. So this URL is <strong>not stable</strong>.</p>";
    ...
    $value .= "<p>When referring to this chapter of the Automorphic project, it is better to say<blockquote>Tag " . $this->chapter["tag"] . "<br>Chapter " . $this->chapter["tag"] . "</blockquote> or refer to the full name of the chapter.</p>";
