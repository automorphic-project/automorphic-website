...
class TodoPage extends Page {
  ...
  public function getMain() {
    ...
    $output .= "<p>What you see here is the current status of the file <a href='https://github.com/automorphic-project/automorphic-project/blob/master/documentation/todo-list'><var>todo-list</var> in the project</a>.";
    $output .= "<ol>";
