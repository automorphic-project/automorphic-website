...
class StatisticsPage extends Page {
  ...
  public function getMain() {
    ...
    $output .= "<dl>";
    $output .= "<dt>Part of the Automorphic project since</dt>";
    if ($this->tag["creation_date"] == "September 11 17:43:00 2016 -0400")
      $output .= "<dd>" . $this->tag["creation_date"] . " (see <a href='" . href("tags#automorphic-epoch") . "'>Automorphic epoch</a>) in <a href='https://github.com/automorphic-project/automorphic-project/commit/" . $this->tag["creation_commit"] . "'>commit " . substr($this->tag["creation_commit"], 0, 7) . "</a>.</dd>";
    else
      $output .= "<dd>" . $this->tag["creation_date"] . " in <a href='https://github.com/automorphic-project/automorphic-project/commit/" . $this->tag["creation_commit"] . "'>commit " . substr($this->tag["creation_commit"], 0, 7) . "</a>.</dd>";
    $output .= "<dt>Last modification to this label (not its contents)</dt>";
    $output .= "<dd>" . $this->tag["modification_date"] . " in <a href='https://github.com/automorphic-project/automorphic-project/commit/" . $this->tag["modification_commit"] . "'>commit " . substr($this->tag["modification_commit"], 0, 7) . "</a>.</dd>";
    $output .= "</dl>";
