...
class MarkdownPage extends Page {
  public function getMain() {
    ...
    $output .= "<pre><code>This is a [link](http://www.google.com). A *little emphasis*, a **lot**.
...
2. list
    ...
    $output .= "<p>Here at the Automorphic project we try to merge Markdown and LaTeX for the comments system. You can write mathematics just like you're used in LaTeX, i.e. stuff like <code>$\\pi$</code> and";
...
\\end{equation}
  ...
  public function getSidebar() {
    ...
    $output .= "<p>If you think you've come across a bug in your comment, please mail the issue (and your comment id, which is visible on the tag lookup page) to <a href='mailto:automorphic.project@gmail.com'>automorphic.project@gmail.com</a>.";
