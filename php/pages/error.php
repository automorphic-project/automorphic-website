...
class ErrorPage extends Page {
  ...
  public function getMain() {
    ...
    $output .= "<p>If you see this, please contact the Automorphic project maintainers at <a href='mailto:automorphic.project@gmail.com'>automorphic.project@gmail.com</a>.";
