...
function GitHubCommitLink($hash) {
  return "https://github.com/automorphic-project/automorphic-project/commit/" . $hash;
}

# link to a specific set of lines in a commit
function GitHubCommitLinesLink($change) {
  return "https://github.com/automorphic-project/automorphic-project/blob/" . $change["hash"] . "/" . $change["file"] . ".tex#L" . $change["begin"] . "-L" . $change["end"];
}
...
function GitHubDiffLink($change) {
  ...
  return "https://github.com/automorphic-project/automorphic-project/commit/" . $change["hash"] . "/" . $change["file"] . ".tex#diff-" . md5($change["file"] . ".tex") . "R" . $change["begin"];
}
