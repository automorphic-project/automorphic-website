...
//(automorphic) The Stacks project has a separate repository for ``tools''. Do we need that?
    ...
    $value .= "<li>The website is based on the Stacks project, which includes a <a href='https://github.com/automorphic-project/automorphic-website'>separate project</a> on the website. It is currently maintained by <a href='http://pbelmans.wordpress.com/'>Pieter Belmans</a>.";
//    $value .= "<li>There is a <a href='https://github.com/automorphic-project/automorphic-tools'>repository</a> containing tools and infrastructure used by both the project and the website.";
    $value .= "</ol>";
